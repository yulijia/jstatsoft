...
| 论文 | Dimension Reduction Regression in R  (application/pdf, 151 KB)| [下载地址](http://www.jstatsoft.org/v07/i01/paper) |
| 补充材料 | | |
| |dr_1.0.tar.gz: Dimension Reduction R package  (application/x-gzip, 805.4 KB)|  [下载地址](http://www.jstatsoft.org/v07/i01/supp/1) |
| 资源 | [BibTeX](http://www.jstatsoft.org/v07/i01/bibtex) [OAI](http://www.jstatsoft.org/oai?verb=GetRecord&identifier=oai.jstatsoft/v07/i01&prefix=oai_dc)| |
