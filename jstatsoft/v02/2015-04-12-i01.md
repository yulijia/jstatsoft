...
| Title |Server-side Statistics Scripting in PHP | [download](http://www.jstatsoft.org/v02/i01/paper) |
| Reference |Vol. 2, Issue 1, Jun 1997 | |
| | Submitted 1997-03-26, Accepted 1997-06-09| | 
| Type | Article| |
| Abstract | On the UCLA Statistics WWW server there are a large number of demos and calculators that can be used in statistics teaching and research. Some of these demos require substantial amounts of computation, others mainly use graphics. These calculators and demos are implemented in various different ways, reflecting developments in WWW based computing. | |
...
| |
| Paper | Server-side Statistics Scripting in PHP  (application/pdf, 68.6 KB)| [download](http://www.jstatsoft.org/v02/i01/paper) |
| Supplements | | |
| |code.zip: Code folder  (application/zip, 144 KB)|  [download](http://www.jstatsoft.org/v02/i01/supp/1) |
| Resources | [BibTeX](http://www.jstatsoft.org/v02/i01/bibtex) [OAI](http://www.jstatsoft.org/oai?verb=GetRecord&identifier=oai.jstatsoft/v02/i01&prefix=oai_dc)| |
