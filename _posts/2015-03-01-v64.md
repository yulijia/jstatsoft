...
### [gems: An R Package for Simulating from Disease Progression Models](/jstatsoft/v64/i10.html "gems：疾病恶化模型的模拟")
...
### [GPfit: An R Package for Fitting a Gaussian Process Model to Deterministic Simulator Outputs](/jstatsoft/v64/i12.html "GPfit：拟合高斯过程模型确定性模拟输出")
...
### [SAVE: An R Package for the Statistical Analysis of Computer Models](/jstatsoft/v64/i13.html "SAVE：计算机模型的统计分析")
